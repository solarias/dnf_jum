...
//일러스트 관련
var images = "https://googledrive.com/host/0B6rCL-wkBAtKfjIxMWtIeEFZbXhqWF9scTRSR0FMaU9RU09CQlRPZlI4cEtzbnUzd3FGUjA/images/";
...
//==========================================================================================================================================
	...
	document.getElementById("footer_submit").onclick = function() {//부가서비스 접속 선택 시
		...
		if (document.getElementById("etcList").value != "") {
			...
			http://www.gmodules.com/gadgets/ifr?url=https://googledrive.com/host/0B6rCL-wkBAtKflNscVdlNnZGMG16UHdXSnRnd0NMYXkzamYyM0MyT2cyd3MteTNITWZsOW8/jumFraFrame.xml\
			&up_autoGo=&up_displayTime=&up_speed=&up_selectName=&up_selectJob=91&up_selectClass=1\
			&up_selectServer=" + ser.toString() + "\
			&up_selectTarget=" + tar.toString() + "\
			&up_selectFile=9101_" + cha;
		}
	}
	...
	//내 캐릭터 - 추천받으러 가기
		document.getElementById("my_submit").onclick = function() {//다음 진행시
			...
			http://www.gmodules.com/gadgets/ifr?url=https://googledrive.com/host/0B6rCL-wkBAtKflNscVdlNnZGMG16UHdXSnRnd0NMYXkzamYyM0MyT2cyd3MteTNITWZsOW8/jumFraFrame.xml\
			&up_selectJob=91\
			&up_selectClass=" + cla.toString() + "\
			&up_selectName=" + name.toString() + "\
			&up_selectURL=" + imgURL.toString() + "\
			&up_selectServer=" + ser.toString() + "\
			&up_selectTarget=" + tar.toString() + "\
			&up_selectFile=9101_" + cha;
